...
create_work_group <- function(
  ...
  tryCatch(
    {
      do.call(conn@ptr$Athena$create_work_group, request, quote = T)
    },
...
tag_options <- function(key = NULL, value = NULL) {
  stopifnot(is.character(key), is.character(value))
...
delete_work_group <- function(
  ...
  con_error_msg(conn, "Connection already closed.")
  stopifnot(is.character(work_group), is.logical(recursive_delete_option))
  tryCatch(
    {
      conn@ptr$Athena$delete_work_group(
...
get_work_group <- function(conn, work_group = NULL) {
  ...
  tryCatch(
    {
      response <- py_to_r(conn@ptr$Athena$get_work_group(
        WorkGroup = work_group
      ))
    },
    error = function(e) py_error(e)
...
update_work_group <- function(
  ...
  tryCatch(
    {
      do.call(conn@ptr$Athena$update_work_group, request, quote = T)
    },
    error = function(e) py_error(e)
  )
  invisible(NULL)
...
get_session_token <- function(
  ...
  tryCatch(
    ptr <- boto$Session(profile_name = profile_name, region_name = region_name),
    error = function(e) py_error(e)
  )
  ...
  tryCatch(
    {
      response <- py_to_r(do.call(sts$get_session_token, args))
    },
    error = function(e) py_error(e)
  )
...
assume_role <- function(
  ...
  tryCatch(
    {
      response <- py_to_r(sts$assume_role(
        RoleArn = role_arn,
