...
By default `RAthena` performs a retry noisily, this means it will report the exception it has encounted and let the user know how long `RAthena` will wait until it retries again. This is reported in the following format:
